  ...
  return (
    <ThemeProvider attribute='class'>
      <div className='my-14 grid grid-cols-12  gap-6 px-5 sm:px-20 md:px-32 lg:px-48'>
        <div className='relative col-span-12 z-10 rounded-xl bg-white p-4 text-center shadow-custom-light dark:bg-black dark:shadow-custom-dark md:static  lg:col-span-3'>
          <SideBar />
        </div>
